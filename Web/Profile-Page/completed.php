...
$query = "
    ...
    WHERE ms.id_user = $1 AND ms.completed_status = true
";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['movie_id'])) {
    ...
    $query = "UPDATE movie_status SET completed_status = FALSE WHERE id_user = $1 AND id_movie = $2";
...
<head>
    ...
    <title>Completed List Movie Page</title>
